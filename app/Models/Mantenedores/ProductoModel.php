...
class ProductoModel
{
	...
	public static function ListadoProductosPresentacion(
		Int $page_index,
		Int $page_size,
		$idSubFamilia,
		$descripcionProducto
	...
	public static function ListadoProductosPresentacionCodigoBarra(): array
	{
		$res = DB::select("CALL sp_listar_precios_productos_codigo_barra()");
		return $res;
	}
}
